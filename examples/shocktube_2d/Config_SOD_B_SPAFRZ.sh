...
## examples/shocktube_2d/Config_SOD_B_SPAFRZ.sh
...
RD_B_FROZEN_THETA                        # Theta variant: spatial residual, frozen
RD_B_SPATIAL_THETA                       # Theta variant: spatial residual, frozen
